...
export function About() {
  ...
  return (
    <AnimatePage>
      {" "}
      <div className="scene-about" onMouseMove={handleMouseMove}>
        <div className="background-about">
          <Bubbles />
        </div>
        <div className="foreground-about">
        ...
        <div className="container-about">
          ...
          <div className="content-about">
            <h1>
              Descubra a essência da inovação: Bem-vindo à nossa Incubadora do
              Amanhã.
            </h1>
            <p>
              Na Incubadora do Amanhã, acreditamos no poder da criatividade e na
              busca incessante por soluções inovadoras. Nossa missão é catalisar
              o potencial empreendedor, capacitando mentes brilhantes a
              transformarem suas visões em realidade. Nossa abordagem é única,
              combinando um ambiente colaborativo com recursos de ponta e uma
              rede de mentores renomados. Através de programas personalizados de
              aceleração, ajudamos startups a superar obstáculos, impulsionar o
              crescimento e alcançar o sucesso exponencial. Abra as portas para
              uma jornada de descoberta, aprendizado e conexões significativas.
              Junte-se a nós na Incubadora do Amanhã e vamos moldar juntos um
              futuro brilhante e repleto de possibilidades.
            </p>
          </div>
          <Cursor />
        </div>
